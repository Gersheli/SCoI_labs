...
def test_horror_page(): # Get the home page 
    url = 'http://127.0.0.1:8000/Perfume'
    response = requests.get(url)
    assert response.status_code == 200

def test_novel_page(): # Get the home page 
    url = 'http://127.0.0.1:8000/For%20home'
    response = requests.get(url)
    assert response.status_code == 200
...
def test_3():
    url = 'http://127.0.0.1:8000/Perfume/?sort=descending'
    response = requests.get(url)
    assert response.status_code == 200

def test_4():
    url = 'http://127.0.0.1:8000/Perfume/?sort=ascending'
    response = requests.get(url)
    assert response.status_code == 200

def test_5():
    url = 'http://127.0.0.1:8000/For%20home/?sort=descending'
    response = requests.get(url)
    assert response.status_code == 200

def test_6():
    url = 'http://127.0.0.1:8000/For%20home/?sort=ascending'
    response = requests.get(url)
    assert response.status_code == 200
